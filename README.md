...
For quickest setup simply download the executable: [https://github.com/Fourgoblin/documentAnalyzer/releases/tag/v1.5.3](https://github.com/Fourgoblin/documentAnalyzer/releases/tag/v1.5.3)
